...
const Operation: FunctionComponent<Props> = (props) => {

  const {route:{params:{characteristic,peripheralId}},navigation}=props
    ...
    useEffect(()=>{
        ...
        connectAndPrepare(peripheralId,characteristic.service,characteristic.characteristic)

return ()=>{
    BleManager.stopNotification(peripheralId, characteristic.service, characteristic.characteristic)
        .then(() => {
    ...
    const read=()=>{
      if(characteristic.properties.Read){
          BleManager.read(peripheralId,
              characteristic.service,
              characteristic.characteristic).then(readData=>{
